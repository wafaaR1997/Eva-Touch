...
<head>
    <title>Eav touch - Add New Product</title>
...
<div id="wrap">
    ...
    <div class="center_content">
        <div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/upload.png" alt=""/></span>Upload New Product
            </div>
            <div class="feat_prod_box_details">
                <p class="details"></p>
                <div class="contact_form">
                    <div class="form_subtitle">Product Details</div>
                    <form name="add_product" href="#" action="<?= $_SERVER["PHP_SELF"] ?>" method="post"
                        ...
                        <div class="form_row">
                            <input type="submit" class="register" value="upload" name="" id=""/>
                        </div>
                    </form>
                </div>
            </div>
